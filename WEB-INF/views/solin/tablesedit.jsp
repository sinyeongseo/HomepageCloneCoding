                            ...
                            <div class="table-responsive">
                              <article>
									<div class="container" role="main">
										<form action="/editService.do" id="EditForm" method="post">
										<input type="hidden" id="tb_num" name="tb_num" value="${tb_num}" />
											<div class="mb-3">
												<label for="title">제목</label>
												<input type="text" class="form-control" name="tb_title" id="tb_title">
											</div>
											...
											<div>
												<button type="button" class="btn btn-sm btn-primary" id="btnSave" onclick="btnSave()">수정</button>
												<button type="button" class="btn btn-sm btn-primary" id="btnList" onclick="btnList()">취소</button>
											</div>

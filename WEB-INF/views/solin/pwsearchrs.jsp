...
<body>
<% if (request.getAttribute("mb_pw") == null) { %>
    <script>
   		 var link = '/pwsearch.do';
...
<% } %>
	<div class="login-wrapper">
	 <div class="login">
		 ...
		 <h1>PW 조회 결과</h1> <!-- 컨트롤러에서 전달한 데이터 출력 --><br>
		 <div id="box">
		<div><span  style="font-weight:bold">${mb_name}</span> 님의 정보와 일치하는 PW입니다.</div><br>
		<div><span  style="font-weight:bold">PW</span> : <span  style="font-weight:bold">${mb_pw}</span></div><br><br>
